...
| 7 | in progress: 7-day production watch | Model deployed behind YOLO_OPENVINO_MODEL=/app/models/yolo11s_yard_openvino/best.xml, YOLO_BIRD_CLASS=0, YOLO_CONFIDENCE_THRESHOLD=0.35. Container rebuilt and verified healthy. 7-day watch runs 2026-09-20 11:28 UTC to 2026-09-27 11:28 UTC. Monitoring daily junk corrections/day (baseline 6.45), per-tile latency (gate <=0.266s), and false-negative audit channel (50 binary filter rejections). | 2026-09-20, 6f7f383 |
| 8 | not started | | |

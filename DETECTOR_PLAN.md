...
| 5 | in progress: fine-tune single-class YOLO11s on Mac | Fine-tuning YOLO11s on Apple Silicon MPS with 18,200 training tiles; evaluating Gate 5 on held-out days. | |
| 6 | not started | | |
| 7 | not started | | |
| 8 | not started | | |
